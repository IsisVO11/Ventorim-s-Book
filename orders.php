...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Quantidade: <span><?php echo $fetch_orders['quantity']; ?></span></p>
         <p> Valor total: <span>$<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
         <p> Status Pagamento: <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){ echo 'red'; }else{ echo 'green'; } ?>;"><?php echo $fetch_orders['payment_status']; ?></span> </p>
         </div>
      <?php
       }
      }else{
